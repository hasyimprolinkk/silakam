                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="pemirsa1" value="1" name="is_public" class="custom-control-input" {{old('is_public') == '1' ? 'checked' : ''}} onclick="showKet()">
                        ...
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="pemirsa2" value="0" name="is_public" class="custom-control-input" {{old('is_public') == '0' ? 'checked' : ''}} onclick="showKet()">
