...
<div class="min-height-200px">
    ...
    <div class="card-box mb-30 p-2">
        <form action="{{url('data_lapor/status', $lapor->lapor_id)}}" method="POST" class="float-left mr-1">
            @csrf
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <button class="dropdown-item" type="submit" name="belum" value="belum">Belum diproses</button>
                    <button class="dropdown-item" type="submit" name="proses" value="proses">Sedang diproses</button>
                    <button class="dropdown-item" type="submit" name="selesai" value="selesai">Selesai</button>
                </div>
            </div>
        </form>
        <a href="/cetak/{{$lapor->lapor_id}}" class="btn btn-lg btn-primary" target="_blank">Cetak PDF</a>
        <a href="#" data-toggle="modal" data-target="#confirmation-modal" class="btn btn-lg btn-danger">Hapus</a>
        <a href="/lapor/{{$lapor->lapor_id}}/tanggapan" class="btn btn-lg btn-secondary" target="_blank">Tanggapan</a>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    ...
                    <form id="delete-form" action="{{url('data_lapor/delete', $lapor->lapor_id)}}" method="POST">
                        @csrf
                        @method('delete')
                    </form>
                </div>
